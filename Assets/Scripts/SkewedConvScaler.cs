...
public class SkewedConvScaler : MonoBehaviour
{
    public bool isStraightConveyor;
    private MeshRenderer objectRenderer;
    private SkewedConveyor _conveyor;
    ...
    private void Start()
    {
        ...
        _conveyor = GetComponent<SkewedConveyor>();
    ...
    private void CreateRollers()
    {
        ...
        convEnds[0].GetChild(0).localEulerAngles = new Vector3(0, GetComponent<SkewedConveyor>().skewAngle, 0);
        convEnds[1].GetChild(0).localEulerAngles = new Vector3(0, GetComponent<SkewedConveyor>().skewAngle, 0);
        RollersPosition();
    }
    ...
    void RollersPosition()
    {
        ...
        for (int i = 0; i < rollers.childCount; i++)
        {
            ...
            rollers.GetChild(i).localEulerAngles = new Vector3(0, GetComponent<SkewedConveyor>().skewAngle, 0);
        }
    }
    ...
    public void RemakeObject()
    {
        ...
        if(isStraightConveyor) CreateRollers();
        else
        {
